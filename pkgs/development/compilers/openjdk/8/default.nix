...
let
  ...
  openjdk-bootstrap = openjdk8-bootstrap.override { inherit headless; };
  ...
  openjdk8 = stdenv.mkDerivation rec {
    ...
    patches = [
      ./patches/fix-java-home-jdk8.patch
      ./patches/read-truststore-from-env-jdk8.patch
      ./patches/currency-date-range-jdk8.patch
      ./patches/fix-library-path-jdk8.patch
    ] ++ lib.optionals (!headless && enableGnome2) [
      ./patches/swing-use-gtk-jdk8.patch
    ];
