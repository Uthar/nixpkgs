...
, alsaLib, openjdk9-bootstrap, cacert, perl, liberation_ttf, fontconfig, zlib, lndir
...
let
  ...
  openjdk-bootstrap' = openjdk9-bootstrap.override { inherit headless; };
  ...
  openjdk9 = stdenv.mkDerivation rec {
    ...
    patches = [
      ./patches/fix-java-home-jdk9.patch
      ./patches/read-truststore-from-env-jdk9.patch
      ./patches/openjdk-9-pointer-comparison.patch
      ./patches/openjdk-currency-time-bomb.patch 
    ] ++ lib.optionals (!headless && enableGnome2) [
      ./patches/swing-use-gtk-jdk9.patch
    ];
